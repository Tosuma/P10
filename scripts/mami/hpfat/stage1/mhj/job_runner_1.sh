...
FULL_NDRE_VALUES=("0.6" "0.7")
FIRST_BOUNDARY_NDRE="0.5"
FIRST_BOUNDARY_NDVI_VALUES=("0.5" "0.6" "0.7" "0.8" "0.9" "1.0")
SECOND_BOUNDARY_NDRE="0.8"
SECOND_BOUNDARY_NDVI_VALUES=("0.0" "0.1")
