...
#SBATCH --output=logs/hpfat/stage2/train_mami_batch_%j.out
#SBATCH --error=logs/hpfat/stage2/train_mami_batch_%j.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --mem=24G
...
TASK_IDS_CSV=""
ATTEMPT_MAP=""
STATUS_DIR="logs/hpfat/stage2/status/default"
TASK_LOG_DIR="logs/hpfat/stage2/tasks"
LR="1e-5"
LOSS_MRAE_W="1.0"
STAGE2_EPOCHS="300"
...
usage() {
    cat <<'EOF'
Usage:
  sbatch scripts/mami/hpfat/stage2/train_mami_batch_job.sh \
...
mkdir -p "$(dirname "$STATUS_DIR")" "$STATUS_DIR" "$TASK_LOG_DIR" "logs/hpfat/stage2"
        ...
        /bin/bash -lc "source '$VENV_ACTIVATE' && \
            python -u -m torch.distributed.run \
                ...
                mami/mami.py \
                    ...
                    --stage2_lr '${LR}' \
                    --stage2_loss_mrae_w '${LOSS_MRAE_W}' \
                    --stage2_loss_ndvi_w '${ndvi}' \
                    --stage2_loss_ndre_w '${ndre}' \
                    --dir_name '${dir_name}' \
