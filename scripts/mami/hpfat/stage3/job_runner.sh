...
SINGULARITY_IMAGE="/ceph/container/pytorch/pytorch_26.01.sif"
VENV_ACTIVATE="p10_venv/bin/activate"
MAX_SUBMIT_RETRIES=5
SUBMIT_RETRY_SLEEP=60

SBATCH_SCRIPT="scripts/mami/hpfat/stage3/train_mami_batch_job.sh"
LOG_ROOT="logs/hpfat/stage3"
STATUS_DIR=""
...
usage() {
    cat <<'EOF'
Usage:
  bash scripts/mami/hpfat/stage3/job_runner.sh --manifest scripts/mami/hpfat/stage3/tasks_manifest.csv
